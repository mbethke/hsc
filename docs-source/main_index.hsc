...
<*<IMG SRC="docs/image/head.png" ALT="hsc - Another stupid HTML preprocessor">*>
<IMG SRC="docs/image/nomain.png" ALT="----" ALIGN="middle">
<IMG SRC="docs/image/noindex.png" ALT="-----" ALIGN="middle">
<A HREF="docs/copy.html"><IMG SRC="docs/image/copy.png" ALT="Copyright" ALIGN="middle"></A>
<IMG SRC="docs/image/noback.png" ALT="--" ALIGN="middle">
<IMG SRC="docs/image/noprev.png" ALT="--------" ALIGN="middle">
<A HREF="docs/index.html"><IMG SRC="docs/image/next.png" ALT="Next" ALIGN="middle"></A>
<hr>
...
<P><IMG SRC="docs/image/hsc.png" ALT="..SUCK SUCK SUCK.." ALIGN="right"></P>

<P>This is the support w3-page for <hsc>, an HTML preprocessor. It
...
<p><IMG SRC="docs/image/austria.png" ALT="[Austria]">
<A HREF="http://www.giga.or.at/~agi/hsc/"><(HSC.Anchor)></A></p>
<p><IMG SRC="docs/image/teutsch.png" ALT="[Germany]">
