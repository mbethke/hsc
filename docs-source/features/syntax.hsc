<DOCPAGE chapter="hsc - Features - " title="Syntax Check"
    PREV="strip.html"
    NEXT="css.html">
...
<P>(<TechNote> Most errors <hsc> handles are of the kind <qq>Well, now a
have to program this <CODE>if (..)</CODE> to avoid an enforcer hit/segmentation
fault, why not display an error message now..</qq>.)
