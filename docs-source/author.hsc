...
and <A HREF="bugs.html">known bugs and problems</A> before 
you contact me.</P>
...
If you..
<UL>
<LI>..find any bugs (which seems to become more and more unlikely)
...
discussed in the chapter about <A HREF="bugs.html">Known bugs and
limitations</A>, you should include some information in your
bug-report:
<UL>
<LI>Under which operating system did you use <hsc>?
<LI>Which version did you use? You can find this out if you
