<DOCPAGE chapter="hsc - " title="Project Management"
...
commandline option <CODE>PRJFILE</CODE>, for example:</P>
...
commandline option <CODE>PRJFILE=<FILE>projec_file</FILE></CODE>.
...
Another possibility for adding documents is <hscpitt>. For example:
...
<P>Therefore, every time something changed in the project-file, it is left
