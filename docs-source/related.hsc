<DOCPAGE chapter="hsc - " title="Related Stuff"
    PREV="future.html"
...
<UL>
<LI><Aminet FILE="dev/gcc/ixpath.lha"> - commandline only, source code included
...
<UL>
<LI><A HREF="http://www.ology.org/tilt/cgh/">Composing Good HTML</A>,
...
<LI><A HREF="http://www.useit.com/alertbox/">The Alertbox</A>: Current Issues in Web Usability
    - might frustrate you, but answers several <qq>Why?</qq>s. (<(HSC.ANCHOR)>)
<LI>Richard Scarry: <qq>Mein allerschönstes Buch vom Backen, Bauen und
    Flugzeugfliegen</qq> - a general introduction to life and how to cope
    with it.
</UL>
