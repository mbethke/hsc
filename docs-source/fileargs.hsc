<DOCPAGE chapter="hsc - " title="File Options"
    PREV="examples.html"
    NEXT="messages.html">

There are several commandline options to specify where <hsc> should take the
...
<$source pre><IMG SRC="image/back.png" ALT="back"></$source>
...
as before. You can change the default extension using the commandline option
<op-extension>.</P>

<H2>Using Subdirectories</H2>
