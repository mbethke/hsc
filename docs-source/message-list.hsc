<WEBPAGE chapter="hsc - " title="List of Messages"
    PREV="messages.html"
    NEXT="envvar.html"
...
<*
<MSG ID="8" CLASS="fatal" NAME="arithmetic error">

An arithmetic error occurred while processing an expression. Currently,
this denotes an attempt to divide by zero.
*>
...
on using URIs of such kind, you can set the CLI option <op-serverdir>
...
Somethings wrong with a <ln-defent> or <ln-deficon> call.
...
<MSG ID="86" CLASS="warn" NAME="error removing file <i>filename</i>">
